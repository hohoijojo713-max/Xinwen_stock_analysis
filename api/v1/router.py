...
from api.v1.endpoints import (
    agent, alerts, alphasift, analysis, auth, backtest, decision_signals,
    health, history, intelligence, portfolio, stocks, system_config, usage,
    surge_engine,
)
...
router.include_router(surge_engine.router, prefix="/surge-engine", tags=["Surge Engine"])
